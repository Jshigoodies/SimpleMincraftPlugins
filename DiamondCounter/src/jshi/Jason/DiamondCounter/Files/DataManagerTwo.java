package jshi.Jason.DiamondCounter.Files;
...
public class DataManagerTwo {
	private Main plugin;
	private FileConfiguration dataConfig = null;
	private File configFile = null;
	
	
	public DataManagerTwo(Main p)
	{
		this.plugin = p;
	...
	public void reloadConfig()
	{
		...
		{
			this.configFile = new File(this.plugin.getDataFolder(), "data_two.yml"); //create Folder
		}
		
		this.dataConfig = YamlConfiguration.loadConfiguration(this.configFile); //loads the data file
		
		InputStream defaultStream = this.plugin.getResource("data_two.yml"); 
		/*
	...
	public void saveDefaultConfig()
	{
		if(this.configFile == null)
		{
			this.configFile = new File(this.plugin.getDataFolder(), "data_two.yml");
		}
		
		if(!this.configFile.exists())
		{
			this.plugin.saveResource("data_two.yml", false);
		}
	}
}
